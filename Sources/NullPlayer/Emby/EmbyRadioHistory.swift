...
class EmbyRadioHistory {
    ...
    func filterOutHistoryTracks(_ tracks: [Track]) -> [Track] {
        ...
        do {
            ...
            return tracks.filter { track in
                if let tid = track.embyId, trackIds.contains(tid) { return false }
    ...
    var historyPageURL: URL? { URL(string: "http://127.0.0.1:\(LocalMediaServer.httpPort)/emby-radio-history") }
