...
final class CavaWindowController: NSWindowController, CavaWindowProviding {
    private var cavaView: CavaView!
    ...
    private func setupWindow() {
        ...
        window.setAccessibilityIdentifier("CavaWindow")
        window.setAccessibilityLabel("NullPlayer Cava Spectrum Analyzer")
    }

    private func setupView() {
        cavaView = CavaView(frame: NSRect(origin: .zero, size: SkinElements.SpectrumWindow.windowSize))
...
extension CavaWindowController: NSWindowDelegate {
