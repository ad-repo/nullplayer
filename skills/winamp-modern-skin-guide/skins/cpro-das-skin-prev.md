## cPro das-skin-prev (`cpro-das-skin-prev.wal` + ClassicPro engine)

*Per-skin status. Index: [skins.md](../skins.md) · engine-wide surface: [compatibility.md](../compatibility.md) · how a section gets written: `/wal-skin-report <skin.wal>`.*

- **File:** `cpro-das-skin-prev.wal` · 202882 B · SHA-256 `a498f56ae938e6d8…`
...
main/normal        500x500   170 nodes   min 495x324   declared 317x168   max 1920x1080
