## Overdrive 2 (`Overdrive_2.wal`)

*Per-skin status. Index: [skins.md](../skins.md) · engine-wide surface: [compatibility.md](../compatibility.md) · how a section gets written: `/wal-skin-report <skin.wal>`.*

- **File:** `Overdrive_2.wal` · 653,258 B · SHA-256 `146586d098105079…` · author "Ian Novack aka Spoonman aka Novispoon"
...
layouts          3, 119 scene nodes total
...
artwork          92 resolved; unresolved: 1 base, 0 hover/pressed, 0 deliberate draw-nothing
findings         0 error, 4 warning, 0 info
```

**Known outstanding:**

- 1 bitmap id(s) it references do not resolve, leaving a visible gap: `player.anim.volume`
