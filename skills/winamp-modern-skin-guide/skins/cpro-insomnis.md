## cPro Insomnis (`cPro_Insomnis_by_zrco.wal` + ClassicPro engine)

*Per-skin status. Index: [skins.md](../skins.md) · engine-wide surface: [compatibility.md](../compatibility.md) · how a section gets written: `/wal-skin-report <skin.wal>`.*

- **File:** `cPro_Insomnis_by_zrco.wal` · 183258 B · SHA-256 `4db1bc997599b750…`
...
bitmaps main/normal: missing=beatvis.overlay player.o.* size.khzkbps
```

### What differs from cPro-Bento

- **Ships no colour themes** — the drawer menu's *Color Themes* entry is correctly greyed out (`drawer_ct.disabled = ct_fakeLayer.isInvalid()`), the only one of the four where that happens.
- Its `buttons.png` is 297x198 rather than the 332x198 the other three use; 10,613 pixels of it are template filler.
- `main/shade` misses `shade.o.bg.1/2/3`.
