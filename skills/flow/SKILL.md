...
- Modern Flow keeps extra breathing room, but Metal Flow removes that outer content padding so its interior edge matches the thinner Metal border used by the other dockable windows.
