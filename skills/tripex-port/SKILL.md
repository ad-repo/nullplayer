...
Tripex is a visualization engine in NullPlayer's modern visualizer window, switchable from the right-click **Visualization Engine** submenu alongside ProjectM and Geiss. It is a port of the MIT-licensed upstream at `https://github.com/ben-marsh/tripex` (vendored verbatim into `Sources/CTripexCore/upstream/`).
