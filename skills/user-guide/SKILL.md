...
- **Remember State on Quit**: `AppStateManager.restorePlaylistState` restores the playlist, ordering, selected track, and saved seek position; launch stays paused and does not auto-play
