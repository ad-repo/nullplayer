...
enum TestFixtures {
    ...
    static func path(for fixture: String) -> String? {
        return Bundle(for: NullPlayerUITestCase.self).path(forResource: fixture, ofType: nil)
    }
    
    /// Get the URL to a test fixture
    static func url(for fixture: String) -> URL? {
        return Bundle(for: NullPlayerUITestCase.self).url(forResource: fixture, withExtension: nil)
    }
}
...
extension NullPlayerUITestCase {
