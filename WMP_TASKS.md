...
**Start here: W102, in Tier 1e.** `<VIDEO>` is declared by **170 of 179 archives** and hosted on
nothing, and it is now the largest unhosted surface left: W101 closed on 2026-09-09 and the
visualization surface of the corpus draws this player's own visuals in the rect the skin authored.
W103-W105 are the rest of the surface-mapping work; W105's `.visualization` case is unblocked by
W101 and its `.video` case is not.
...
six. W101 closed the same day and made the visualization surface the third.
