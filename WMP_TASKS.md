...
`scripts/wmp_skin_census.sh /tmp/wmp/census`. **179 of 179 load, and 574 of 595 views lay out**,
re-measured 2026-09-07 after W6's content-sized views; a row below that still cites 567, 515, 508,
506 or 482 views was not re-measured then.
