...
- **Cover Flow in the Library browser** — a new **FLOW** toggle turns the current library list into a 3D, horizontally-scrolling wall of album artwork, available in all three skin families (Modern, Metal, Classic). It's a visual lens over whatever you're browsing: scroll or use the arrow keys to flip through covers, the centered item's name shows beneath the carousel, and a wider window fans out more covers. Clicking a **container** (artist, folder, …) enters it and shows its contents, with a **‹ Back** cover to step out — folder/subfolder and artist→album navigation both work to any depth. Clicking an **album** plays the whole album; clicking a **track** plays it. In Modern/Metal the covers float above the Library window's Cava/art backdrop, honoring whatever backdrop mode you've set.
